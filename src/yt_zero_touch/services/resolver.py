...
================================================
Turns a page URL into a direct, downloadable stream URL.
Brightcove embeds, Formula1, and headless-browser stream interception.
"""
...
class _TempBrowser:
    """One-shot Playwright browser; close() shuts down Chromium and Playwright context."""

    def __init__(self):
        if not _PLAYWRIGHT_OK or sync_playwright is None:
